      ...
      lessons: [
        {
          ...
          xp: 30,
          content: `
            <h2>📊 ¿Qué es Microsoft Excel?</h2>
            <p>Excel es una hoja de cálculo que te permite:</p>
            <br/>
            <ul style="margin-left:20px;line-height:2">
              <li>📝 <strong>Organizar datos</strong> en filas y columnas</li>
              <li>🧮 <strong>Realizar cálculos</strong> con fórmulas</li>
              <li>📈 <strong>Crear gráficos</strong> visuales</li>
              <li>📊 <strong>Analizar información</strong> rápidamente</li>
            </ul>
          `,
          quiz: {
